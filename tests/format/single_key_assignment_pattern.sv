...
module single_key_assignment_pattern;
    always_ff @(posedge clk) begin
        ...
        nested_multiple <= '{payload: '{value: 1, default: '0}};
        multiple <= '{value: 1, default: '0};
        prefix <= '{ // Clear all entries.
            default: '0
        };
        inline_comment <= '{default: /* Clear */ '0};
        long_value <= '{value: first_long_signal_name + second_long_signal_name + third_long_signal_name + fourth_long_signal_name};
        commented <= '{
