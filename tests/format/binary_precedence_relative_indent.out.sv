...
module binary_precedence_relative_indent;
    always_comb result = address_pkg::scalar_memory_address_t'(region_selector[0]
                                                                   * arch_pkg::branch_count
                                                                   * address_pkg::folds_per_branch
                                                               + branch_ids[region_selector]
                                                                   * address_pkg::folds_per_branch
                                                               + control.scalar_index);
