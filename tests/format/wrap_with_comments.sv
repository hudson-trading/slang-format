module wrap_with_comments;
    ...
    wire bar = (very_long_signal_name_a && very_long_signal_name_b) || // comment between operands
    (very_long_signal_name_c && very_long_signal_name_d);

    // Wrap without comments (baseline)
    wire baz = (very_long_signal_name_a && very_long_signal_name_b) || (very_long_signal_name_c && very_long_signal_name_d);
