module test;
    ...
    always_comb begin
        result = compute_something(/* first_operand */ very_long_variable_name_alpha, /* second_operand */ very_long_variable_name_beta, /* third_operand */ very_long_variable_name_gamma);
    end
