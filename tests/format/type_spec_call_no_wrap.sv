...
module demo #(
    ...
    initial begin
        source_group.endpoints[index].extended_metadata_analysis_port.connect(handlers[index].extended_metadata_analysis_imp);
        $display($bits(example_types_pkg::extended_metadata_record_with_a_deliberately_long_name_t));
    end
endmodule
