...
module test;
    always_comb begin
        ...
        if (some_long_condition_alpha || some_long_condition_beta || some_long_condition_gamma || some_long_condition_delta) begin
            x = y;
        end
        ...
        if (a) begin
            x = 1;
        end else if (another_long_condition_aaaa || another_long_condition_bbbb || another_long_condition_cccc || another_long_condition_dddd) begin
            x = 2;
        end
    end
endmodule
